/* This program will use the sizeof on classes and their instances. */
...
int main()
{
    MyString mansName("Devon");
    MyString womansName("Dawn");
    ...
    Human firstMan(mansName, 26, true);
    Human firstWoman(womansName, 29, false);
