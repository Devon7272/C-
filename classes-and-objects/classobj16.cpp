/* This will be declaration, instantiation, and sizeof() union. Unions are used as members of a struct to model a
 * complex data type. Some implmentations use the ablility of a union to interpret the fixed memory space as another
 * type is used for type conversion or memory reinterpretation. This pratice is very controversial and not necessary
