/* Demonstrates the use of a function that contains default values for parameters taht can be overridden with a user
 * supplied value, if avaliable and desired. */
#include <iostream>
using namespace std;
